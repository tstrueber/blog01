...
![created by pch.vector, downloaded from freepik.com]({{ '/assets/wordpress-import/2024/07/Engineer-working-with-server-equipment-and-switchboard-1024x890.jpg' | relative_url }})
### 1. **Enhanced Security**
...
![]({{ '/assets/wordpress-import/2024/07/image-19-1024x406.png' | relative_url }})
...
![]({{ '/assets/wordpress-import/2024/07/image-18-1024x343.png' | relative_url }})

I will add the Authenticator app because it has higher authentication strength than SMS:

![from Microsoft]({{ '/assets/wordpress-import/2024/07/image-32-1024x480.png' | relative_url }})
...
![]({{ '/assets/wordpress-import/2024/07/image-16-1024x568.png' | relative_url }})

Once you've enabled it, you can make MFA mandatory for your users (Enforce):

![]({{ '/assets/wordpress-import/2024/07/image-17-1024x595.png' | relative_url }})
## Add Custom Domain

Next, you'll want to add your custom domain to your tenant.

![]({{ '/assets/wordpress-import/2024/07/image-20-1024x452.png' | relative_url }})
...
![]({{ '/assets/wordpress-import/2024/07/image-21-1024x478.png' | relative_url }})

You must copy that TXT value and create the DNS Record:

![]({{ '/assets/wordpress-import/2024/07/image-22-1024x483.png' | relative_url }})

In my case I have a domain at IONOS - here you create a new TXT-Record:

![]({{ '/assets/wordpress-import/2024/07/image-23-1024x596.png' | relative_url }})

And paste the copied value:

![]({{ '/assets/wordpress-import/2024/07/image-24-1024x800.png' | relative_url }})

Then you went back to the Microsoft 365 Admin center and verify your domain:

![]({{ '/assets/wordpress-import/2024/07/image-25-1024x844.png' | relative_url }})
...
![]({{ '/assets/wordpress-import/2024/07/image-26-1024x409.png' | relative_url }})

You'll get a few DNS records. Just follow the instructions and add them correctly:

![]({{ '/assets/wordpress-import/2024/07/image-27-1024x737.png' | relative_url }})

Once you've added all the records, just click on "Continue." If everything looks good, you'll get a confirmation:

![]({{ '/assets/wordpress-import/2024/07/image-28-1024x394.png' | relative_url }})
...
![]({{ '/assets/wordpress-import/2024/07/image-29-1024x518.png' | relative_url }}) ![]({{ '/assets/wordpress-import/2024/07/image-30-1024x375.png' | relative_url }})

Select your custom domain:

![]({{ '/assets/wordpress-import/2024/07/image-31-1024x526.png' | relative_url }})
