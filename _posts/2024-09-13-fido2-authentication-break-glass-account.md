...
![]({{ '/assets/wordpress-import/2024/09/image.png' | relative_url }})
...
![]({{ '/assets/wordpress-import/2024/09/image-1.png' | relative_url }})

Here you must enable support for this authentication method:

![]({{ '/assets/wordpress-import/2024/09/image-2.png' | relative_url }})
...
![]({{ '/assets/wordpress-import/2024/09/image-24.png' | relative_url }})
...
![]({{ '/assets/wordpress-import/2024/09/image-12.png' | relative_url }})

Copy the provided access pass because you will need it later:

![]({{ '/assets/wordpress-import/2024/09/image-25.png' | relative_url }})
...
![]({{ '/assets/wordpress-import/2024/09/image-13-1024x947.png' | relative_url }})

You will then need to register a new factor:

![]({{ '/assets/wordpress-import/2024/09/image-14-945x1024.png' | relative_url }})
...
![]({{ '/assets/wordpress-import/2024/09/image-15-1024x722.png' | relative_url }})

Then select "Passkey":

![]({{ '/assets/wordpress-import/2024/09/image-16-1024x906.png' | relative_url }})

Here you can see a hint that we can only use a passkey with one of the defined AAGUIDs:

![]({{ '/assets/wordpress-import/2024/09/image-27-1024x774.png' | relative_url }})

Next, click "Set up passkey using another device":

![]({{ '/assets/wordpress-import/2024/09/image-26-1024x757.png' | relative_url }})
...
![]({{ '/assets/wordpress-import/2024/09/image-30-872x1024.png' | relative_url }})

Since this is the first time I am using this security key, I am forced to set a PIN for it:

![]({{ '/assets/wordpress-import/2024/09/image-19-1024x789.png' | relative_url }})

Now I have to touch the security key to complete the process:

![]({{ '/assets/wordpress-import/2024/09/image-20-1024x811.png' | relative_url }})

Finally, I have to confirm that login.microsoft.com has access to the security key:

![]({{ '/assets/wordpress-import/2024/09/image-21-1024x765.png' | relative_url }})

To distinguish between different passkeys, you must enter a name for the one you have just registered:

![]({{ '/assets/wordpress-import/2024/09/image-22-1024x691.png' | relative_url }})

The passkey is now created and can be used to log in:

![]({{ '/assets/wordpress-import/2024/09/image-28-1024x614.png' | relative_url }}) ![]({{ '/assets/wordpress-import/2024/09/image-29-1024x584.png' | relative_url }})

If we check the security information afterwards, we can see the registered security key:

![]({{ '/assets/wordpress-import/2024/09/image-39.png' | relative_url }})
...
![]({{ '/assets/wordpress-import/2024/09/image-40.png' | relative_url }})
...
![]({{ '/assets/wordpress-import/2024/09/image-41-980x1024.png' | relative_url }})
...
![]({{ '/assets/wordpress-import/2024/09/image-31-1005x1024.png' | relative_url }})

You will then see a popup asking you to select "Security Key" again:

![]({{ '/assets/wordpress-import/2024/09/image-32-771x1024.png' | relative_url }})

The wizard will then ask you to insert and touch the USB security key. Once inserted, it will start flashing:

![]({{ '/assets/wordpress-import/2024/09/image-36-842x1024.png' | relative_url }})

Now you need to verify with your defined PIN:

![]({{ '/assets/wordpress-import/2024/09/image-34-1024x714.png' | relative_url }})

And you have to touch the security key again to confirm the request:

![]({{ '/assets/wordpress-import/2024/09/image-35-1024x757.png' | relative_url }})
...
![]({{ '/assets/wordpress-import/2024/09/image-37.png' | relative_url }})

Under authentication details we can see that we used our "Break Glass Yubikey":

![]({{ '/assets/wordpress-import/2024/09/image-38.png' | relative_url }})
## Conclusion
