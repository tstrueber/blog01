---
layout: post
title: Minimize Distractions on your iPhone
date: 2024-02-22 09:51:42.000000000 +01:00
categories:
- Productivity
tags:
- iPhone
...
If you want to work deeply, you may be looking for ways to minimize distractions. Your brain needs time to switch from one context to another, so it is important for your productivity to stick to the specific topic you are working on. You can train your brain to stay in deep work mode and concentrate on a specific task. However, external factors can disrupt your focus. This article provides tips for minimizing distractions on your iPhone.

## Your phone is a massive distraction

There is an article that states [the average person checks their phone 110 times a day](https://www.dailymail.co.uk/sciencetech/article-2449632/How-check-phone-The-average-person-does-110-times-DAY-6-seconds-evening.html), but another study suggests the number may be closer to 150. Notifications on your phone can distract you from your current task, and boredom may also lead you to pick up your phone, such as when waiting in line for coffee. You may find yourself in any situation waiting for a few minutes, and it has become the norm to spend this time on your phone, as it tends to grab your attention. However, grabbing your attention is worse when you should be doing something productive, such as completing a new blog article. If you struggle to find the right words, you may subconsciously decide to pick up your phone and check your Instagram feed. Before you know it, you have spent 30 minutes of your precious time doomscrolling.

## Tools & Techniques

In this article, I will describe tools and techniques to minimize distractions on your iPhone. While I won't cover Android phones, there may be similar options available on the Google OS.

### Home Screen Design

Upon unlocking your screen, the first thing you will see is your home screen. If you have any missed notifications from your messaging apps, you might be tempted to check them. The same goes for social media apps like Instagram - upon seeing the icon, you may feel the urge to check your feed for new content.
...
1. Productivity Apps
  - Notes & Tasks (including shortcuts for quick creation without the need of opening the app!)
  - Calendar
  - time tracking
  - Authentication Apps
  - Safari
...
I have removed every app that I don't need. Apps that I don't use regularly are no longer on my home screen. I prefer to keep my home screen clean and organized.
...
The configuration for the scheduled summary is located within the notification center.
        ...
        1. You have to enable the feature at the top
...
I have enabled this feature for the Outlook app since I primarily use my laptop during work hours. When a new email arrives, it is acceptable for me to receive it during one of the scheduled times. As shown in the screenshot, I have intentionally disabled this feature for my calendar app because I want to be notified when there is an upcoming appointment.
...
You can use this feature to define a downtime for your off-work time and only allow specific apps that you wish to use after work.
...
This is a useful feature for limiting the usage of specific apps at specific times. Not only can you suppress notifications, but you can also limit the usage of the app.

### Focus Mode

The 'Focus mode' feature is an excellent way to limit notifications. It can be found in the settings and can be configured to suit your needs. You can create multiple modes, each with different behaviors, to accommodate various situations throughout the day.
...
The screenshot on the left displays the 'people' configuration. You can choose to work with either a block list or an allow list. When working with the allow list, you can add specific contacts or allow all of your favorite contacts.
...
A useful feature is that you can sync your quiet time automatically to Microsoft Teams.
...
While my plan may not fit your needs, I hope the overview of the tools covered in this article will help you make your day more productive and less distracting.
