---
layout: post
title: Create a Microsoft 365 Tenant
date: 2024-07-09 08:38:17.000000000 +02:00
categories:
- How To Guides
tags:
- Microsoft 365
permalink: "/create-a-microsoft-365-tenant/"
...
[Compare Microsoft 365 Business Plans and Pricing | Microsoft 365](https://www.microsoft.com/en/microsoft-365/business/compare-all-microsoft-365-business-products?market=af)

![]({{ '/assets/wordpress-import/2024/07/image-1-1024x769.png' | relative_url }})
...
![]({{ '/assets/wordpress-import/2024/07/image-2-1024x740.png' | relative_url }})
...
![]({{ '/assets/wordpress-import/2024/07/image-3-1024x715.png' | relative_url }})
...
![]({{ '/assets/wordpress-import/2024/07/image-4-1024x583.png' | relative_url }})

Then you'll need to decide how many licenses you need after the first free test month ends:

![]({{ '/assets/wordpress-import/2024/07/image-5-1024x590.png' | relative_url }})

And of course you must provide a payment method in form of a credit card:

![]({{ '/assets/wordpress-import/2024/07/image-6-1024x767.png' | relative_url }})

Finally you can review all relevant information and create the Tenant!

![]({{ '/assets/wordpress-import/2024/07/image-7-1024x630.png' | relative_url }})
...
![]({{ '/assets/wordpress-import/2024/07/image-8-1024x765.png' | relative_url }})

That's it - you have created a M365 Tenant :-)

![]({{ '/assets/wordpress-import/2024/07/image-9-1024x755.png' | relative_url }})
## Summary
